...
void serial_vec_sclr_div(double *a_vec, double *out_vec,  double sclr,
                          int size);
void serial_mtx_col_copy(double *vec, double *mtx,  int col_index,
                          int size);
void serial_mtx_vec_mul(double *a_mtx, double *b_vec, double *out_vec,
                         int num_rows,  int num_cols);
void serial_spmv(int *a_row_ptrs, int *a_columns, double *a_vals,
...
void serial_calc_w(double *w_vec,  double alpha, double *orth_mtx,
